# Tasks: Define Spectrum Enum

- [x] Ensure `DoubleColon` (::) token exists in lexer <!-- id: 11 -->
- [x] Define `AST` nodes for `spectrum` definition and instantiation <!-- id: 0 -->
- [x] Update `Type` enum to support `Spectrum` <!-- id: 1 -->
- [x] Implement parsing for `spectrum` definition <!-- id: 2 -->
- [x] Implement parsing for `Spectrum::Variant` instantiation <!-- id: 3 -->
